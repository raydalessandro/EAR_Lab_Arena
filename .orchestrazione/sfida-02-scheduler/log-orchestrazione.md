# Log di orchestrazione — Sfida 02

> Questo file si scrive **mentre** il round è in corso, in
> `.orchestrazione/sfida-02-scheduler/log-orchestrazione.md`. È il diario
...
- **Stato iniziale del repo passato a Sfidante**: working directory
  in `sfida-02-scheduler/`, working branch dal main. Sfidante non riceve
