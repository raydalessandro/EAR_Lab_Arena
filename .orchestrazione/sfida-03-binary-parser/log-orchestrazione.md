# Log di orchestrazione — Sfida 03

> Questo file si scrive **mentre** il round è in corso, in
> `.orchestrazione/sfida-03-binary-parser/log-orchestrazione.md`. È il diario
...
- **Stato iniziale del repo passato a Sfidante**: working directory
  in `sfida-03-binary-parser/`, working branch dal main. Sfidante non riceve
