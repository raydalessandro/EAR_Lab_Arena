...
This directory is the **`binary-parser` module** of a larger internal repository.
...
Tests use **vitest**. See `package.json` for scripts and `vite.config.ts` for the build config.
